...
// Image imports
// Definimos a URL da imagem das receitas diretamente
const recipeImage = "/recipe-image.png";

// Usamos a mesma imagem para todos os testimonials
const testimonialImage = recipeImage;
