...
export default function SalesPage() {
  return (
    ...
    >
      <h1 className="text-2xl md:text-3xl font-bold text-center mb-6">On vous a menti.</h1>

      <p className="text-lg mb-4">
        Vous pouvez manger un <strong>brownie fondant</strong>, une <strong>brioche moelleuse</strong>, ou une <strong>tartelette chocolat-noisette</strong> — <em>sans sucre, sans gluten, sans lactose.</em>
      </p>

      <p className="text-lg mb-8">Et vous resservir. Sans culpabilité.</p>

      <div className="bg-primary/10 p-4 rounded-xl mb-8">
        <p className="text-primary font-medium text-center">
          🎁 En 1 minute, découvrez votre <strong>profil gourmand</strong> et accédez à la <em>collection privée</em> de 500 recettes emblématiques de la Chef Amélie.
        </p>
      </div>
